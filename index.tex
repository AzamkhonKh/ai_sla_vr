...
\textbf{Service Level Agreement (SLA):} Performance guarantees defined in terms of measurable metrics such as latency, availability, and throughput. In this work, we use service level agreement-style targets as design constraints rather than contractual obligations.
...
The complete SysML model and architectural specifications are available at: \texttt{https://github.com/AzamkhonKh/ai\_sla\_vr}
